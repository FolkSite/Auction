...
class AuctionOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('auction_item_err_ns');
        }
...
return 'AuctionOfficeItemUpdateProcessor';
