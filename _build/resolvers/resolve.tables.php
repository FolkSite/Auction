...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('auction_core_path', null,
                    $modx->getOption('core_path') . 'components/auction/') . 'model/';
            $modx->addPackage('auction', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/auction/model/schema/auction.mysql.schema.xml';
